...
{
    public class InterfaceMethodsMismatchException : System.Exception
    {
        ...
        public InterfaceMethodsMismatchException(Type type, Type clientInterface, System.Exception innerException)
        ...
        private static string Format(ParameterInfo parameterInfo)
        {
        ...
        private static string CreateMessage(Type observableInterface, Type clientInterface)
        {
