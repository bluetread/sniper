...
namespace Sniper.Tests.Conventions
{
    public class ModelTests
    {
        ...
        private static IEnumerable<Type> GetAllModelTypes(ISet<Type> allModelTypes)
        {
        ...
        private static void GetPropertyModelTypes(Type modelType, ISet<Type> allModelTypes)
        {
