...
namespace Sniper.Tests.Conventions
{
    public class PaginationTests
    {
        ...
        private static MethodInfo MethodHasAppropriateOverload(MethodInfo method, MethodInfo[] methodsOrdered)
        {
        ...
        private static bool MethodHasOverloadForApiOptions(MethodInfo methodInfo, ParameterInfo[] expected)
        {
