...
namespace Sniper.Tests.Integration.Clients
{
    public class EventsClientTests
    {
        ...
        public class TheGetAllForRepositoryMethod
        {
            ...
            {
                var github = Helper.GetAuthenticatedClient();
                var events = await github.Activity.Events.GetAllForRepository("Sniper", "Sniper");
            ...
            public async Task ReturnsCorrectCountOfEventsWithoutStart()
            {
                ...
                var eventInfos = await github.Activity.Events.GetAllForRepository("Sniper", "Sniper", options);
            ...
            public async Task ReturnsDistinctEventsBasedOnStartPage()
            {
                ...
                var firstPage = await github.Activity.Events.GetAllForRepository("Sniper", "Sniper", startOptions);
                ...
                var secondPage = await github.Activity.Events.GetAllForRepository("Sniper", "Sniper", skipStartOptions);
        ...
        public class TheGetAllIssuesForRepositoryMethod
        {
            ...
            {
                var github = Helper.GetAuthenticatedClient();
                var issues = await github.Activity.Events.GetAllIssuesForRepository("Sniper", "Sniper");
            ...
            public async Task ReturnsCorrectCountOfEventsWithoutStart()
            {
                ...
                var eventInfos = await github.Activity.Events.GetAllIssuesForRepository("Sniper", "Sniper", options);
            ...
            public async Task ReturnsDistinctEventsBasedOnStartPage()
            {
                ...
                var firstPage = await github.Activity.Events.GetAllIssuesForRepository("Sniper", "Sniper", startOptions);
                ...
                var secondPage = await github.Activity.Events.GetAllIssuesForRepository("Sniper", "Sniper", skipStartOptions);
