...
namespace Sniper.Tests.Integration.Clients
{
    public class IssueTimelineClientTests : IDisposable
    {
        ...
        {
            var timelineEventInfos = await _issueTimelineClient.GetAllForIssue("Sniper", "Sniper.net", 1503);
        ...
        public async Task CanRetrieveTimelineForIssueWithApiOptions()
        {
            ...
            timelineEventInfos = await _issueTimelineClient.GetAllForIssue("Sniper", "Sniper.net", 1503, pageOptions);
            Assert.NotEmpty(timelineEventInfos);
