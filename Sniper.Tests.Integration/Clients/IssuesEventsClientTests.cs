...
namespace Sniper.Tests.Integration.Clients
{
    public class IssuesEventsClientTests : IDisposable
    {
        ...
        {
            var issueEvent = await _issuesEventsClient.Get("Sniper", "Sniper.net", 490490630);
            ...
            Assert.Equal(new Uri("https://api.github.com/repos/Sniper/Sniper.net/commits/0bb8747a0ad1a9efff201ea017a0a6a4f69b797e"), issueEvent.CommitUrl);
        }
