...
namespace Sniper.Tests.Integration.Clients
{
    public class PullRequestReviewCommentReactionsClientTests : IDisposable
    {
        ...
        private const string branchHead = "heads/" + branchName;
        private const string branchRef = "refs/" + branchHead;
        ...
        /// </summary>
        /// <returns></returns>
        private async Task<PullRequestData> CreatePullRequest(RepositoryContext context)
        {
