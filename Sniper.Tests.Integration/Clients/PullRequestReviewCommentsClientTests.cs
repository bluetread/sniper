...
namespace Sniper.Tests.Integration.Clients
{
    public class PullRequestReviewCommentsClientTests : IDisposable
    {
        ...
        private const string branchName = "new-branch";
        private const string path = "CONTRIBUTING.md";
        ...
        private async Task<PullRequestReviewComment> CreateComment(string body, int position, string commitId, int number)
        {
            return await CreateComment(body, position, _context.RepositoryName, commitId, number);
        }

        private async Task<PullRequestReviewComment> CreateCommentWithRepositoryId(string body, int position, string commitId, int number)
        {
        ...
        private async Task<PullRequestReviewComment> CreateComment(string body, int position, long repositoryId, string pullRequestCommitId, int pullRequestNumber)
        {
            var comment = new PullRequestReviewCommentCreate(body, pullRequestCommitId, path, position);
        ...
        private async Task CreateComments(IEnumerable<string> comments, int position, string repoName, string pullRequestCommitId, int pullRequestNumber)
        {
        ...
        private static void AssertComment(PullRequestReviewComment comment, string body, int position)
        {
        ...
        private static void AssertComments(IReadOnlyList<PullRequestReviewComment> comments, List<string> bodies, int position)
        {
        ...
        /// </summary>
        /// <returns></returns>
        private async Task<PullRequestData> CreatePullRequest(RepositoryContext context, string branch = branchName)
        {
        ...
        private async Task<int> HelperCreatePullRequestReviewCommentWithReactions(string owner, string repo, PullRequestData pullRequest)
        {
