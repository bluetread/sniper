...
namespace Sniper.Tests.Integration.Clients
{
    public class PullRequestsClientTests : IDisposable
    {
        ...
        private const string otherBranchName = "my-other-branch";
        ...
        public async Task CanBrowseFiles()
        {
            ...
            {
                new PullRequestFile(null, "Sniper.Tests.Integration/Clients/ReferencesClientTests.cs", null, 8, 3, 11, null, null, null, null),
                new PullRequestFile(null, "Sniper/Clients/ApiPagination.cs", null, 21, 6, 27, null, null, null, null),
                new PullRequestFile(null, "Sniper/Helpers/IApiPagination.cs", null, 1, 1, 2, null, null, null, null),
                new PullRequestFile(null, "Sniper/Http/ApiConnection.cs", null, 1, 1, 2, null, null, null, null)
            };

            var result = await _fixture.Files("Sniper", "Sniper.net", 288);
