...
namespace Sniper.Tests.Integration.Clients
{
    public class ReleasesClientTests
    {
        ...
        public class TheGetAllMethod
        {
            ...
            private const long repositoryId = 252774;
        ...
        public class TheUploadAssetMethod : IDisposable
        {
            ...
            private const string owner = "Sniper";
            private const string name = "Sniper.net";
            private const int releaseId = 2248679;
        ...
        public class TheGetLatestReleaseMethod
        {
            ...
            {
                var lastReleaseFromGetAll = (await _releaseClient.GetAll("Sniper", "Sniper.net")).OrderBy(r => r.CreatedAt).Last();
                var lastRelease = await _releaseClient.GetLatest("Sniper", "Sniper.net");
