    ...
    public class RepositoriesClientTests
    {
        ...
        public class TheGetMethod
        {
            ...
            public async Task ReturnsOrganizationRepository()
            {
                ...
                var repository = await github.Repository.Get("Sniper", "Sniper.net");

                Assert.Equal("https://github.com/Sniper/Sniper.net.git", repository.CloneUrl);
                Assert.False(repository.Private);
                Assert.False(repository.Fork);
        ...
        public class TheGetAllContributorsMethod
        {
            ...
            public async Task GetsContributors()
            {
                ...
                var contributors = await github.Repository.GetAllContributors("Sniper", "Sniper.net");
            ...
            public async Task ReturnsCorrectCountOfContributorsWithoutStart()
            {
                ...
                var contributors = await github.Repository.GetAllContributors("Sniper", "Sniper.net", options);
            ...
            public async Task GetsPagesOfContributors()
            {
                ...
                var firstPage = await github.Repository.GetAllContributors("Sniper", "Sniper.net", firstPageOptions);
                ...
                var secondPage = await github.Repository.GetAllContributors("Sniper", "Sniper.net", secondPageOptions);
        ...
        public class TheGetAllLanguagesMethod
        {
            ...
            public async Task GetsLanguages()
            {
                ...
                var languages = await github.Repository.GetAllLanguages("Sniper", "Sniper.net");
        ...
        public class TheGetAllTagsMethod
        {
            ...
            public async Task GetsTags()
            {
                ...
                var tags = await github.Repository.GetAllTags("Sniper", "Sniper.net");
            ...
            public async Task ReturnsCorrectCountOfTagsWithoutStart()
            {
                ...
                var tags = await github.Repository.GetAllTags("Sniper", "Sniper.net", options);
            ...
            public async Task GetsPagesOfTags()
            {
                ...
                var firstPage = await github.Repository.GetAllTags("Sniper", "Sniper.net", firstPageOptions);
                ...
                var secondPage = await github.Repository.GetAllTags("Sniper", "Sniper.net", secondPageOptions);
        ...
        public class TheGetAllBranchesMethod
        {
            ...
            public async Task GetsAllBranches()
            {
                ...
                var branches = await github.Repository.GetAllBranches("Sniper", "Sniper.net");
            ...
            public async Task ReturnsCorrectCountOfBranchesWithoutStart()
            {
                ...
                var branches = await github.Repository.GetAllBranches("Sniper", "Sniper.net", options);
            ...
            public async Task GetsPagesOfBranches()
            {
                ...
                var firstPage = await github.Repository.GetAllBranches("Sniper", "Sniper.net", firstPageOptions);
                ...
                var secondPage = await github.Repository.GetAllBranches("Sniper", "Sniper.net", secondPageOptions);
        ...
        public class TheGetBranchMethod
        {
            ...
            public async Task GetsABranch()
            {
                ...
                var branch = await github.Repository.GetBranch("Sniper", "Sniper.net", "master");
        ...
        public class TheGetAllTeamsMethod
        {
            ...
            public async Task GetsAllTeams()
            {
                ...
                var branches = await github.Repository.GetAllTeams("Sniper", "Sniper.net");
            ...
            public async Task ReturnsCorrectCountOfTeamsWithoutStart()
            {
                ...
                var teams = await github.Repository.GetAllTeams("Sniper", "Sniper.net", options);
            ...
            public async Task GetsPagesOfBranches()
            {
                ...
                var firstPage = await github.Repository.GetAllTeams("Sniper", "Sniper.net", firstPageOptions);
                ...
                var secondPage = await github.Repository.GetAllTeams("Sniper", "Sniper.net", secondPageOptions);
