    ...
    public class RepositoryBranchesClientTests
    {
        public class TheGetAllMethod
        {
            ...
            public async Task GetsAllBranches()
            {
                ...
                var branches = await github.Repository.Branch.GetAll("Sniper", "Sniper.net");
            ...
            public async Task ReturnsCorrectCountOfBranchesWithoutStart()
            {
                ...
                var branches = await github.Repository.Branch.GetAll("Sniper", "Sniper.net", options);
            ...
            public async Task GetsPagesOfBranches()
            {
                ...
                var firstPage = await github.Repository.Branch.GetAll("Sniper", "Sniper.net", firstPageOptions);
                ...
                var secondPage = await github.Repository.Branch.GetAll("Sniper", "Sniper.net", secondPageOptions);
        ...
        public class TheGetMethod
        {
            ...
            public async Task GetsABranch()
            {
                ...
                var branch = await github.Repository.Branch.Get("Sniper", "Sniper.net", "master");
        ...
        {
            private IRepositoryBranchesClient _client;
            private RepositoryContext _userRepoContext;
            private OrganizationRepositoryWithTeamContext _orgRepoContext;
        ...
        public class TheUpdateProtectedBranchTeamRestrictionsMethod : IDisposable
        {
            private IRepositoryBranchesClient _client;
            private OrganizationRepositoryWithTeamContext _orgRepoContext;
            private TeamContext _contextOrgTeam2;
            private IGitHubClient _github;
