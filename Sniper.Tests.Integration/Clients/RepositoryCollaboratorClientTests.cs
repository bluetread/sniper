        ...
        public class TheGetAllMethod
        {
            ...
            public async Task ReturnsAllCollaborators()
            {
                ...
                using (var context = await github.CreateRepositoryContext(new NewRepository(repoName)))
                {
                    ...
                    // add a collaborator
                    await fixture.Add(context.RepositoryOwner, context.RepositoryName, "m-zuber-Sniper-integration-tests");
            ...
            public async Task ReturnsAllCollaboratorsWithRepositoryId()
            {
                ...
                using (var context = await github.CreateRepositoryContext(new NewRepository(repoName)))
                {
                    ...
                    // add a collaborator
                    await fixture.Add(context.Repository.Id, "m-zuber-Sniper-integration-tests");
        ...
        public class TheIsCollaboratorMethod
        {
            ...
            public async Task ReturnsTrueIfUserIsCollaborator()
            {
                ...
                using (var context = await github.CreateRepositoryContext(new NewRepository(repoName)))
                {
                    ...
                    var isCollab = await fixture.IsCollaborator(context.RepositoryOwner, context.RepositoryName, "m-zuber-Sniper-integration-tests");
            ...
            public async Task ReturnsTrueIfUserIsCollaboratorWithRepositoryId()
            {
                ...
                using (var context = await github.CreateRepositoryContext(new NewRepository(repoName)))
                {
                    ...
                    var isCollab = await fixture.IsCollaborator(context.Repository.Id, "m-zuber-Sniper-integration-tests");
        ...
        public class TheDeleteMethod
        {
            ...
            public async Task CheckDeleteMethod()
            {
                ...
                using (var context = await github.CreateRepositoryContext(new NewRepository(repoName)))
                {
                    ...
                    // and remove
                    await fixture.Delete(context.RepositoryOwner, context.RepositoryName, "m-zuber-Sniper-integration-tests");
            ...
            public async Task CheckDeleteMethodWithRepositoryId()
            {
                ...
                using (var context = await github.CreateRepositoryContext(new NewRepository(repoName)))
                {
                    ...
                    // and remove
                    await fixture.Delete(context.Repository.Id, "m-zuber-Sniper-integration-tests");
