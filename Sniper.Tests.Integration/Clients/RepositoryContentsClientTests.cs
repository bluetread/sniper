    ...
    public class RepositoryContentsClientTests
    {
        public class TheGetReadmeMethod
        {
            ...
            public async Task ReturnsReadmeForSeeGit()
            {
                ...
                var readme = await github.Repository.Content.GetReadme("Sniper", "Sniper.net");
                ...
                Assert.Contains("Sniper - GitHub API Client Library for .NET", readMeHtml);
            }
            ...
            public async Task ReturnsReadmeHtmlForSeeGit()
            {
                ...
                var readmeHtml = await github.Repository.Content.GetReadmeHtml("Sniper", "Sniper.net");
                Assert.True(readmeHtml.StartsWith("<div class="));
        ...
        public class TheGetContentsMethod
        {
            ...
            public async Task GetsFileContent()
            {
                ...
                var contents = await github
                    .Repository
                    .Content
                    .GetAllContents("Sniper", "Sniper.net", "Sniper.Reactive/ObservableGitHubClient.cs");

                Assert.Equal(1, contents.Count);
                Assert.Equal(ContentType.File, contents.First().Type);
                Assert.Equal(new Uri("https://github.com/Sniper/Sniper.net/blob/master/Sniper.Reactive/ObservableGitHubClient.cs"), contents.First().HtmlUrl);
            }
            ...
            public async Task GetsFileContentWithRepositoryId()
            {
                ...
                var contents = await github
                    .Repository
                    .Content
                    .GetAllContents(7528679, "Sniper.Reactive/ObservableGitHubClient.cs");
            ...
            public async Task GetsDirectoryContent()
            {
                ...
                var contents = await github
                    .Repository
                    .Content
                    .GetAllContents("Sniper", "Sniper.net", "Sniper");
        ...
        public class TheGetContentsByRefMethod
        {
            ...
            public async Task GetsFileContent()
            {
                ...
                var contents = await github
                    .Repository
                    .Content
                    .GetAllContentsByRef("Sniper", "Sniper.net", "Sniper.Reactive/ObservableGitHubClient.cs", "master");
            ...
            public async Task GetsFileContentWithRepositoryId()
            {
                ...
                var contents = await github
                    .Repository
                    .Content
                    .GetAllContentsByRef(7528679, "Sniper.Reactive/ObservableGitHubClient.cs", "master");
            ...
            public async Task GetsDirectoryContent()
            {
                ...
                var contents = await github
                    .Repository
                    .Content
                    .GetAllContentsByRef("Sniper", "Sniper.net", "Sniper", "master");
            ...
            public async Task GetsDirectoryContentWithRepositoryId()
            {
                ...
                var contents = await github
                    .Repository
                    .Content
                    .GetAllContentsByRef(7528679, "Sniper", "master");
