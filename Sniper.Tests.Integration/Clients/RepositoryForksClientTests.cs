    ...
    public class RepositoryForksClientTests
    {
        public class TheGetAllMethod
        {
            ...
            public async Task ReturnsForksForRepository()
            {
                ...
                var forks = await github.Repository.Forks.GetAll("Sniper", "Sniper.net");

                var masterFork = forks.FirstOrDefault(fork => fork.FullName == "TeamBinary/Sniper.net");
            ...
            public async Task ReturnsCorrectCountOfForksWithoutStart()
            {
                ...
                var forks = await github.Repository.Forks.GetAll("Sniper", "Sniper.net", options);
            ...
            public async Task ReturnsDistinctForksBasedOnStartPage()
            {
                ...
                var firstPage = await github.Repository.Forks.GetAll("Sniper", "Sniper.net", startOptions);
                ...
                var secondPage = await github.Repository.Forks.GetAll("Sniper", "Sniper.net", skipStartOptions);
            ...
            public async Task ReturnsCorrectCountOfForksWithoutStartParameterized()
            {
                ...
                var forks = await github.Repository.Forks.GetAll("Sniper", "Sniper.net", repositoryForksListRequest, options);
            ...
            public async Task ReturnsDistinctForksBasedOnStartPageParameterized()
            {
                ...
                var firstPage = await github.Repository.Forks.GetAll("Sniper", "Sniper.net", repositoryForksListRequest, startOptions);
                ...
                var secondPage = await github.Repository.Forks.GetAll("Sniper", "Sniper.net", repositoryForksListRequest, skipStartOptions);
            ...
            public async Task ReturnsForksForRepositorySortingTheResultWithOldestFirst()
            {
                ...
                var actualForks = (await github.Repository.Forks.GetAll("Sniper", "Sniper.net", new RepositoryForksListRequest { Sort = Sort.Oldest })).ToArray();
        ...
        public class TheCreateMethod
        {
            ...
            public async Task ForkCreatedForUserLoggedIn()
            {
                ...
                Helper.DeleteRepo(Helper.GetAuthenticatedClient().Connection, Helper.Credentials.Login, "Sniper.net");

                var github = Helper.GetAuthenticatedClient();

                var forkCreated = await github.Repository.Forks.Create("Sniper", "Sniper.net", new NewRepositoryFork());

                Assert.NotNull(forkCreated);
                Assert.Equal(string.Format("{0}/Sniper.net", Helper.UserName), forkCreated.FullName);
            ...
            public async Task ForkCreatedForOrganization()
            {
                ...
                Helper.DeleteRepo(Helper.GetAuthenticatedClient().Connection, Helper.Organization, "Sniper.net");

                var github = Helper.GetAuthenticatedClient();

                var forkCreated = await github.Repository.Forks.Create("Sniper", "Sniper.net", new NewRepositoryFork { Organization = Helper.Organization });

                Assert.NotNull(forkCreated);
                Assert.Equal(string.Format("{0}/Sniper.net", Helper.Organization), forkCreated.FullName);
                Assert.Equal(true, forkCreated.Fork);
            }
