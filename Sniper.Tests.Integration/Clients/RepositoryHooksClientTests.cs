...
using Sniper.Tests.Integration.fixtures;
...
namespace Sniper.Tests.Integration.Clients
{
    public class RepositoryHooksClientTests
    {
        ...
        {
            private readonly RepositoriesHooksFixture _fixture;
        ...
        public class TheCreateMethod
        {
            ...
            private Dictionary<string, string> CreateExpectedConfigDictionary(Dictionary<string, string> config, string url, WebHookContentType contentType, string secret)
            {
            ...
            private string CreateExpectedBaseHookUrl(string url, int id)
            {
                return url + "/hooks/" + id;
            }
        }
        ...
        private static void AssertHook(RepositoryHook expectedHook, RepositoryHook actualHook)
        {
