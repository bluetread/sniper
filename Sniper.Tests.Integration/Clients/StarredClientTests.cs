...
namespace Sniper.Tests.Integration.Clients
{
    public class StarredClientTests : IDisposable
    {
        ...
        public async Task ReturnsCorrectCountOfRepositoriesWithoutStartAllStargazers()
        {
            ...
            var users = await _fixture.GetAllStargazers("Sniper", "Sniper.net", options);
        ...
        public async Task ReturnsDistinctRepositoriesBasedOnStartPageAllStargazers()
        {
            ...
            var firstPage = await _fixture.GetAllStargazers("Sniper", "Sniper.net", startOptions);
            ...
            var secondPage = await _fixture.GetAllStargazers("Sniper", "Sniper.net", skipStartOptions);
        ...
        public async Task ReturnsCorrectCountOfRepositoriesWithoutStartAllStargazersWithTimestamps()
        {
            ...
            var userStars = await _fixture.GetAllStargazersWithTimestamps("Sniper", "Sniper.net", options);
        ...
        public async Task ReturnsDistinctRepositoriesBasedOnStartPageAllStargazersWithTimestamps()
        {
            ...
            var firstPage = await _fixture.GetAllStargazersWithTimestamps("Sniper", "Sniper.net", startOptions);
            ...
            var secondPage = await _fixture.GetAllStargazersWithTimestamps("Sniper", "Sniper.net", skipStartOptions);
