    ...
    public class WatchedClientTests
    {
        ...
        public class TheGetAllWatchersMethod
        {
            ...
            public async Task CanRetrieveResults()
            {
                ...
                var repositories = await github.Activity.Watching.GetAllWatchers("Sniper", "Sniper.net");
            ...
            public async Task ReturnsCorrectCountOfRepositoriesWithoutStart()
            {
                ...
                var repositories = await github.Activity.Watching.GetAllWatchers("Sniper", "Sniper.net", options);
            ...
            public async Task ReturnsDistinctPullRequestsBasedOnStartPage()
            {
                ...
                var firstPage = await github.Activity.Watching.GetAllWatchers("Sniper", "Sniper.net", startOptions);
                ...
                var secondPage = await github.Activity.Watching.GetAllWatchers("Sniper", "Sniper.net", skipStartOptions);
        ...
        {
            private readonly IWatchedClient _watchingClient;
