    ...
    public class GistsClientTests
    {
        ...
        public class TheGetAllForUserMethod
        {
            ...
            public void RequestsCorrectGetGistsForAUserUrl()
            {
                ...
                client.GetAllForUser("Sniper");

                connection.Received().GetAll<Gist>(Arg.Is<Uri>(u => u.ToString() == "users/Sniper/gists"), Args.ApiOptions);
            }
            ...
            public void RequestsCorrectGetGistsForAUserUrlWithApiOptions()
            {
                ...
                client.GetAllForUser("Sniper", options);

                connection.Received().GetAll<Gist>(Arg.Is<Uri>(u => u.ToString() == "users/Sniper/gists"), options);
            }
            ...
            public void RequestsCorrectGetGistsForAUserWithSinceUrl()
            {
                ...
                DateTimeOffset since = DateTimeOffset.Now;
                client.GetAllForUser("Sniper", since);

                connection.Received().GetAll<Gist>(Arg.Is<Uri>(u => u.ToString() == "users/Sniper/gists"),
                    DictionaryWithSince, Args.ApiOptions);
            }
            ...
            public void RequestsCorrectGetGistsForAUserWithSinceUrlAndApiOptions()
            {
                ...
                DateTimeOffset since = DateTimeOffset.Now;
                client.GetAllForUser("Sniper", since, options);
