...
namespace Sniper.Tests.Clients
{
    public class UserEmailsClientTests
    {
        ...
        public class TheAddMethod
        {
            ...
            {
                var client = new UserEmailsClient(Substitute.For<IApiConnection>());
                await Assert.ThrowsAsync<ArgumentException>(() => client.Add("Sniper@github.com", null));
            }
        }
        ...
        public class TheDeleteMethod
        {
            ...
            {
                var client = new UserEmailsClient(Substitute.For<IApiConnection>());
                await Assert.ThrowsAsync<ArgumentException>(() => client.Delete("Sniper@github.com", null));
            }
        }
