...
namespace Sniper.Tests.Http
{
    public class ConnectionTests
    {
        ...
        private static readonly Uri _exampleUri = new Uri(exampleUrl);
        ...
        public class TheGetMethod
        {
            ...
            public async Task SendsProperlyFormattedRequest()
            {
                ...
                var connection = new Connection(new ProductHeaderValue("SniperTests"),
                    _exampleUri,
        ...
        public class TheConstructor
        {
            ...
            {
                var connection = new Connection(new ProductHeaderValue("SniperTests"), new Uri("https://github.com/"));

                Assert.Equal(new Uri("https://github.com/"), connection.BaseAddress);
                Assert.True(connection.UserAgent.StartsWith("SniperTests ("));
            }
        }
