...
namespace Sniper.Tests.Http
{
    public class RedirectHandlerTests
    {
        ...
        private static Func<HttpMessageHandler> CreateMockHttpHandler(HttpResponseMessage httpResponseMessage1, HttpResponseMessage httpResponseMessage2 = null)
        {
    ...
    {
        private readonly HttpResponseMessage _response1;
        private readonly HttpResponseMessage _response2;
