namespace Sniper.Tests
{
    ...
    public class TargetProcessClientTests
    {
        ...
        public class TheCtor
        {
            ...
            {
                Assert.Throws<ArgumentNullException>(() => new TargetProcessClient((IConnection)null));
                Assert.Throws<ArgumentNullException>(() => new TargetProcessClient((ProductHeaderValue)null));
                ...
                Assert.Throws<ArgumentNullException>(() => new TargetProcessClient(productInformation, (ICredentialStore)null));
                Assert.Throws<ArgumentNullException>(() => new TargetProcessClient(null, credentialStore));

                Assert.Throws<ArgumentNullException>(() => new TargetProcessClient(productInformation, (Uri)null));
                Assert.Throws<ArgumentNullException>(() => new TargetProcessClient(null, baseAddress));

                Assert.Throws<ArgumentNullException>(() => new TargetProcessClient(null, (ICredentialStore)null));
                Assert.Throws<ArgumentNullException>(() => new TargetProcessClient(null, (Uri)null));

                Assert.Throws<ArgumentNullException>(() => new TargetProcessClient(productInformation, null, null));
                Assert.Throws<ArgumentNullException>(() => new TargetProcessClient(null, credentialStore, null));
                Assert.Throws<ArgumentNullException>(() => new TargetProcessClient(null, null, baseAddress));

                Assert.Throws<ArgumentNullException>(() => new TargetProcessClient(null, credentialStore, baseAddress));
                Assert.Throws<ArgumentNullException>(() => new TargetProcessClient(productInformation, null, baseAddress));
                Assert.Throws<ArgumentNullException>(() => new TargetProcessClient(productInformation, credentialStore, null));
            }

            //[Fact]
            //public void CreatesAnonymousClientByDefault()
            //{
            //    var client = new TargetProcessClient(new ProductHeaderValue("SniperTests", "1.0"));
            ...
            //{
            //    var client = new TargetProcessClient(new ProductHeaderValue("SniperTests"))
            //    {
            ...
            //{
            //    var client = new TargetProcessClient(new ProductHeaderValue("UnitTest"), new Uri(baseAddress));
        ...
        //        var client = new TargetProcessClient(new ProductHeaderValue("SniperTests"), credentialStore);
        ...
        public class TheLastApiInfoProperty
        {
            ...
            public async Task ReturnsNullIfNew()
            {
                ...
                var client = new TargetProcessClient(connection);
