...
namespace Sniper.Tests
{
    public class GitHubClientTests
    {
        public class TheCtor
        {
            ...
            {
                var client = new GitHubClient(new ProductHeaderValue("SniperTests", "1.0"));
            ...
            {
                var client = new GitHubClient(new ProductHeaderValue("SniperTests"))
                {
        ...
        public class TheCredentialsProperty
        {
            ...
            public void IsRetrievedFromCredentialStore()
            {
                ...
                var client = new GitHubClient(new ProductHeaderValue("SniperTests"), credentialStore);
