...
namespace Sniper.ToBeRemoved
{
    public static class OldGitHubToBeRemoved
    {
        public const string Activity = "activity";
        public const string AdditionsAndDeletions = "additionsAndDeletions";
        ...
        public const string BaseReference = "baseReference";
        public const string Branch = "branch";
        public const string Client = "client";
        public const string Color = "color";
        public const string Commit = "commit";
        public const string CommentBody = "commit";
        public const string Contexts = "contexts";
        public const string CredentialStore = "credentialStore";
        public const string Comment = "comment";
        public const string CommentUpdate = "commentUpdate";
        ...
        public const string GetHandler = "getHandler";
        ...
        public const string IssueUpdate = "issueUpdate";
        public const string KeyId = "keyId";
        public const string LabelName = "labelName";
        public const string Labels = "labels";
        public const string LabelUpdate = "labelUpdate";
        public const string LdapDistinguishedName = "ldapDistinguishedName";
        public const string Limit = "limit";
        public const string Links = "links";
        public const string MarkAsReadRequest = "markAsReadRequest";
        public const string Merge = "merge";
        public const string MergePullRequest = "mergePullRequest";
        public const string Message = "message";
        public const string Migration = "migration";
        public const string MilestoneUpdate = "milestoneUpdate";
        public const string Login = "login";
        public const string Name = "name";
        public const string NewBlob = "newBlob";
        public const string NewComment = "newComment";
        public const string NewCommitComment = "newCommitComment";
        public const string NewCommitStatus = "newCommitStatus";
        public const string NewDeployment = "newDeployment";
        public const string NewDeploymentKey = "newDeployKey";
        public const string NewDeploymentStatus = "newDeploymentStatus";
        public const string NewImpersonationToken = "newImpersonationToken";
        ...
        public const string NewPullRequest = "newPullRequest";
        public const string NewSubscription = "newSubscription";
        public const string NewTree = "newTree";
        public const string NewUser = "newUser";
        public const string NextPageFunc = "nextPageFunc";
        public const string Org = "org";
        public const string Organization = "organization";
        public const string OrganizationLogin = "organizationLogin";
        ...
        public const string ReferenceUpdate = "update";
        ...
        public const string ThreadSubscription = "threadSubscription";
        public const string Timeout = "timeout";
        public const string Title = "title";
        public const string Token = "token";
        public const string Update = "update";
        public const string UpdateName = "update.Name";
