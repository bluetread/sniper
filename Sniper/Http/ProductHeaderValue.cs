namespace Sniper.Http
{
    ...
    /// name used should represent the product that's using Sniper.
    /// </summary>
    /// <remarks>
    ...
    /// so that consumers of Sniper would not have to add a reference to the System.Net.Http.Headers namespace.
    /// </remarks>
    public class ProductHeaderValue
    {
        private readonly System.Net.Http.Headers.ProductHeaderValue _productHeaderValue;

        /// <summary>
        /// Initializes a new instance of the <see cref="ProductHeaderValue"/> class.
        /// </summary>
        /// <param name="name">The name of the product that's using Sniper</param>
        ...
        /// </summary>
        /// <param name="name">The name of the product that's using Sniper</param>
        /// <param name="version">The version of the product that's using Sniper</param>
        public ProductHeaderValue(string name, string version)
            : this(new System.Net.Http.Headers.ProductHeaderValue(name, version))
        {
        }

        private ProductHeaderValue(System.Net.Http.Headers.ProductHeaderValue productHeader)
        {
